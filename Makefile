...
# coq_makefile -arg -w -notation-overriden,-deprecated christodoulou.v congestion.v dist.v dyadic.v dynamics.v extrema.v games.v numerics.v potential.v routing.v smooth.v 
#
...
OPT?=
OTHERFLAGS=-w -deprecated,-notation-overridden,-parsing
